...
public class PerfilActivity extends AppCompatActivity implements NavigationView.OnNavigationItemSelectedListener{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        getSupportActionBar().setTitle(userdb.getUser().get(0).getNombre() + " " + userdb.getUser().get(0).getApellido());
        ...
        nav_menu.findItem(R.id.nav_perfil).setChecked(true);
        ...
        txtNombre.setText(userdb.getUser().get(0).getNombre() + " " + userdb.getUser().get(0).getApellido());
        txtTelefono.setText(userdb.getUser().get(0).getTelefono1());
        txtDireccion.setText(userdb.getUser().get(0).getDireccion());
        txtEmail.setText(userdb.getUser().get(0).getCorreo());
    }
                ...
                alertDialog.setButton(AlertDialog.BUTTON_POSITIVE, "Salir",
                        new DialogInterface.OnClickListener() {
                            public void onClick(DialogInterface dialog, int which) {
                                ...
                                Intent login = new Intent(PerfilActivity.this,LoginActivity.class);
                                startActivity(login);
                                finish();
                            }
                        });
    ...
    public void getDetallePedido(String iduser, String token,String idpedido){
        dialog = new ProgressDialog(PerfilActivity.this);
        ...
        callT.enqueue(new Callback<SavePedidoResponse>() {
            ...
            public void onResponse(Call<SavePedidoResponse> call, retrofit2.Response<SavePedidoResponse> response) {
                ...
                if( Res.getErrorCode() == 0){
                    ...
                    {
                        Intent a = new Intent(PerfilActivity.this, EstadoPedidoActivity.class);

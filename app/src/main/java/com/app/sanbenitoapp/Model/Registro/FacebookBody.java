...
public class FacebookBody
{
    ...
    public FacebookBody(String correo, String nombre, String apellido, String token_push, String token_facebook, String telefono1, String telefono2, String direccion, String tipo_usuario) {
        this.correo = correo;
        this.nombre = nombre;
